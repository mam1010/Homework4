...
HD_PWD='/home/user/Documents/Homework4/Homework4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_dsp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adder_dsp.tcl -notrace
