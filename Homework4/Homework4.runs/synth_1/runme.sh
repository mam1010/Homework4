...
HD_PWD='/home/user/Documents/Homework4/Homework4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_dsp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder_dsp.tcl
